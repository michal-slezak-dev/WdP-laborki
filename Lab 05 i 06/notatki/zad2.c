...
void AddHead2(ListaJ **head, struct Osoba d) // to head to adres calej struktury, dane to tez struct cala osoba
...
// musze zwroci nowego heada, a head to ListaJ ma typ, przekazywalismy zawartosc heada a nie jego adres dlatego voida nie mozna
    ...
    //void bo ** zeby mmiec adres wskaznika do heada, do oryginalu, adres heada, oryginalu
    // 1. Alokacja 
    ...
    nowa->next = *head; // mamy tu pozostala czesc listy, kolejne elementy *head, bo tak jak w swapie wczesniej, wyluskuje adres z heada do 1. elementu
...
int main() // na poczatek listy wstawia, struktura tak jak na podanych wczesniej slajdach
{
    ...
    ListaJ *head = NULL;
    struct Osoba o1; // struct Osoba o1 = {"Adam", "Kowal", 25};
